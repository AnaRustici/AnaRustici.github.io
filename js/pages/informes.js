...
let mensajeCargando = document.getElementById('texto-cargando');
let informesContainer = document.getElementById('tabla-informes');
let seccionContenido = document.getElementById('sec-contenido');
let seccionTitulo = document.getElementById('sec-titulo');

mensajeCargando.style.visibility = 'hidden';
seccionTitulo.style.visibility = 'hidden';
...
function armarUrl(datos) {
    ...
    mesaId = datosInforme[8];
    añoSeleccionado = datosInforme[9];
    cargoSeleccionado = datosInforme[10];
